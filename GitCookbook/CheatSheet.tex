...
\newcommand{\hmwkTitle}{Homework} % Assignment title
\newcommand{\hmwkDueDate}{Monday,\ 29,\ 2,\ 2016} % Due date
\newcommand{\hmwkClass}{CSE 563} % Course/class
%\newcommand{\hmwkClassTime}{10:30am} % Class/lecture time
%\newcommand{\hmwkClassInstructor}{Jones} % Teacher/lecturer
\newcommand{\hmwkStatement}{The submitted solutions are my individual work.} % Teacher/lecturer
\newcommand{\hmwkAuthorName}{Hongfei Xue} % Your name
\newcommand{\hmwkUBIT}{UBIT: hongfeix} % Your name
...
\subsection{Views Used for This Problem}

\subsubsection{View SEC}
\ref{SEC1}
\sqlscript{SEC1}{}%to add description
\subsubsection{View SE}
\ref{SE1}
\sqlscript{SE1}{}%to add description
\subsubsection{View MCGCSE}
\ref{MCGCSE}
\sqlscript{MCGCSE}{}%to add description
