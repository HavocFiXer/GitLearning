...
\lstset{language=bash, % Use Perl in this example
		...
		morekeywords=[1]{global, HEAD, apt, get, m },
        %
        % Put Perl function parameters here
        morekeywords=[2]{add, install, config, init, commit},
        %
...
\end{lstlisting}
用于将文件提交到Git仓库，之前add中的所有文件都会在一次commit中被提交。-m后添加对于本次提交的说明。
\end{CJK*}
\end{homeworkProblem}
%----------------------------------------------------------------------------------------
%    Chapter 3
